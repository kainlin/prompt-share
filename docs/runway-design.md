...
- **Weight 450 — the precision detail**: Some small uppercase labels use weight 450, an uncommon intermediate between regular (400) and medium (500). This micro-craft detail ensures that the text maintains geometric clarity even at tiny scales.
