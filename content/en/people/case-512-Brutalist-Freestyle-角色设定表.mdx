---
title: "Brutalist Freestyle 角色设定表"
category: people
tags: []
emoji: "🧍"
cover: case512_thumb.webp
images:
  - case512_full.jpg
source:
  platform: Unknown
...
<CaseHeader
  ...
  title="Brutalist Freestyle 角色设定表"
  tags={[]}
  source={{platform: "Unknown", author: "[@ShamsAmin56](https://x.com/S"}}
/>

<ImageGallery images={["case512_full.jpg"]} alt="Brutalist Freestyle 角色设定表" />
